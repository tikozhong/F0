...
#define EXTERN_DHCP_SN     ConfigMsg.net.sub
#define EXTERN_DHCP_GW     ConfigMsg.net.gw
#define EXTERN_DHCP_DNS    ConfigMsg.net.dns
#define EXTERN_DHCP_NAME   "iweb"//ConfigMsg.domain
#define EXTERN_DHCP_SIP    ConfigMsg.net.ip
