...
#define MOTOR_APP_TICK_IN_4MS 16
typedef struct{
...
typedef struct{
	...
	//ÉèÖÃÁ¦¾Ø
	bool (*SetKVal)					(cSPIN_Rsrc_T* pRsrc, u8 hold, u8 run, u8 acc, u8 dec);
	bool (*getKVal)					(cSPIN_Rsrc_T* pRsrc, u8* hold, u8* run, u8* acc, u8* dec);
	...
	bool (*RegSetSwMode) 		(cSPIN_Rsrc_T* pRsrc, bool param);
	bool (*RegGetSwMode) 		(cSPIN_Rsrc_T* pRsrc, bool *param);
	bool (*RegSetVsCompEn) 	(cSPIN_Rsrc_T* pRsrc, bool param);
	bool (*RegGetVsCompEn) 	(cSPIN_Rsrc_T* pRsrc, bool *param);
	bool (*RegSetOCSDEn) 		(cSPIN_Rsrc_T* pRsrc, bool param);
	bool (*RegGetOCSDEn) 		(cSPIN_Rsrc_T* pRsrc, bool *param);
	bool (*RegSetUVLOVal)		(cSPIN_Rsrc_T* pRsrc, bool param);
	bool (*RegGetUVLOVal) 	(cSPIN_Rsrc_T* pRsrc, bool *param);
	bool (*RegSetVccVal) 		(cSPIN_Rsrc_T* pRsrc, bool param);
	bool (*RegGetVccVal) 		(cSPIN_Rsrc_T* pRsrc, bool *param);
	bool (*RegSetPwmFrq) 		(cSPIN_Rsrc_T* pRsrc, u8 param);
	bool (*RegGetPwmFrq) 		(cSPIN_Rsrc_T* pRsrc, u8 *param);
	//bool (*RegGetStatus) 		(cSPIN_Rsrc_T* pRsrc, u16 *param);

	void (*Set_All)			(cSPIN_Rsrc_T* pRsrc);
	void (*Get_All)			(cSPIN_Rsrc_T* pRsrc);
	void (*Get_Few)			(cSPIN_Rsrc_T* pRsrc);
	...
	void (*Run)					(cSPIN_Rsrc_T* pRsrc, cSPIN_Direction_TypeDef direction, u32 speed);
	void (*Step_Clock)	(cSPIN_Rsrc_T* pRsrc, cSPIN_Direction_TypeDef direction);
	void (*Move)				(cSPIN_Rsrc_T* pRsrc, cSPIN_Direction_TypeDef direction, u32 n_step);
	void (*Go_To)				(cSPIN_Rsrc_T* pRsrc, u32 abs_pos);
	void (*Go_To_Dir)		(cSPIN_Rsrc_T* pRsrc, cSPIN_Direction_TypeDef direction, u32 abs_pos);
	void (*Go_Until)		(cSPIN_Rsrc_T* pRsrc, cSPIN_Action_TypeDef action, cSPIN_Direction_TypeDef direction, u32 speed);
	void (*Release_SW)	(cSPIN_Rsrc_T* pRsrc, cSPIN_Action_TypeDef action, cSPIN_Direction_TypeDef direction);
	...
	void (*tickExe) 		(cSPIN_Rsrc_T* pRsrc);
...
void cSPIN_Setup(cSPIN_DEV_T* pDev);
