 ...
 */
#define tAD779X_ModeRegister_SET(ModeSel,ClkSrcSel,FilterSel)	(FilterSel|(ClkSrcSel<<6)|(ModeSel<<13))
#define tAD779X_ModeRegister_SetMod(reg,ModeSel)	((reg&(0xffff^(0x07<<13)))|((ModeSel&0x07)<<13))
#define tAD779X_ModeRegister_SetClk(reg,ClkSrcSel)	((reg&(0xffff^(0x03<<6)))|((ClkSrcSel&0x03)<<6))
#define tAD779X_ModeRegister_SetFS(reg,FilterSel)	((reg&(0xffff^(0x0f<<0)))|((FilterSel&0x0f)<<0))

//typedef u16 tAD779X_ModeRegister;
//{
//	u8 FS;
//	
//	struct
//	{
//	u8 FS      :4; /*!< Filter Update Rate Select */
//	u8 UNUSED1 :2; /*!< These bits must be programmed with a Logic 0 for correct operation */
//	u8 CLKS    :2; /*!< Clock source Select */
//	u8 UNUSED0 :5; /*!< These bits must be programmed with a Logic 0 for correct operation */
//	u8 MODE    :3; /*!< Mode Select */
//	};
//	unsigned short DATA; 
 ...
 */
#define tAD779X_ConfigRegister_SET(VBIAS, BO, POL, BOOST, GAIN, REFSEL, BUF, CH)	\
(CH|(BUF<<4)|(REFSEL<<7)|(GAIN<<8)|(BOOST<<11)|(POL<<12)|(BO<<13)|(VBIAS<<14))
#define tAD779X_ConfigRegister_SetRef(reg,ref)	((reg&(0xffff^(0x01<<7)))|((ref&0x01)<<7))
#define tAD779X_ConfigRegister_SetCh(reg,ch)	((reg&(0xffff^(0x07<<0)))|((ch&0x07)<<0))
#define tAD779X_ConfigRegister_SetGain(reg,gain)	((reg&(0xffff^(0x07<<8)))|((gain&0x07)<<8))
#define tAD779X_ConfigRegister_SetPol(reg,pol)	((reg&(0xffff^(0x01<<12)))|((pol&0x01)<<12))
#define tAD779X_ConfigRegister_SetBuf(reg,buf)	((reg&(0xffff^(0x01<<4)))|((buf&0x01)<<4))
typedef u16 tAD779X_ConfigRegister;
//typedef union
//{
//	struct
//	{
 ...
 */
#define tAD779X_IORegister_SET(IEXCENSelect,IEXCDIRSelect)	(IEXCENSelect|(IEXCDIRSelect<<2))
#define tAD779X_IORegister_SetIEXCEN(reg,IEXCENSel)	((reg&(0xff^(0x03<<0)))|(IEXCENSel<<0))
#define tAD779X_IORegister_SetIEXCDIR(reg,IEXCDIRSel)	((reg&(0xff^(0x03<<2)))|(IEXCDIRSel<<2))



typedef u8 tAD779X_IORegister;
//typedef union
//{
//	struct
//	{
 ...
 */
typedef u32 tAD779X_DataSample;
//typedef union
//{
...
typedef struct
{
	tAD779X_Rsrc rsrc;
	//api
	u32 (*adcCode)(tAD779X_Rsrc *pRsrc);
	u32 (*adcVolt)(tAD779X_Rsrc *pRsrc);
	
	//op
	void (*Init)(tAD779X_Rsrc *pRsrc);
	void (*Reset)(tAD779X_Rsrc *pRsrc);
	void (*WriteModeRegister)(tAD779X_Rsrc *pRsrc, unsigned short Data);
	void (*WriteConfigRegister)(tAD779X_Rsrc *pRsrc, unsigned short Data);
	void (*WriteIORegister)(tAD779X_Rsrc *pRsrc, unsigned char Data);
//	u16 (*HWDetect)(tAD779X_Rsrc *pRsrc);
	u8 (*GetStatus)(tAD779X_Rsrc *pRsrc);
	u32 (*ReadDataRegister)(tAD779X_Rsrc *pRsrc);	
//	u8 (*CheckReadySW)(tAD779X_Rsrc *pRsrc);
//	u8 (*CheckReadyHW)(tAD779X_Rsrc *pRsrc);
	void (*SetMode)(tAD779X_Rsrc *pRsrc, tAD779X_ModeSelect Mode);
//	void (*SetClkSource)(tAD779X_Rsrc *pRsrc, tAD779X_ClkSourceSelect ClkSource);
//	void (*SetUpdateRate)(tAD779X_Rsrc *pRsrc, tAD779X_FilterSelect UpdateRates);
	void (*SetExCurrentValue)(tAD779X_Rsrc *pRsrc, tAD779X_IEXCENSelect excValue);
	void (*SetExCurrentDirection)(tAD779X_Rsrc *pRsrc, tAD779X_IEXCDIRSelect excDirection);
	void (*StartZSCalibration)(tAD779X_Rsrc *pRsrc);
	void (*StartFSCalibration)(tAD779X_Rsrc *pRsrc);
     void (*SetBuffer)(tAD779X_Rsrc *pRsrc, u8);
 
 
     u16 (*ReadConfigReg)     (tAD779X_Rsrc *pRsrc);
     u16 (*ReadModeReg)       (tAD779X_Rsrc *pRsrc);
 
	u32 (*GetVol)(tAD779X_Rsrc *pRsrc);

//	void (*SetContinueRead)(tAD779X_Rsrc *pRsrc, u8);
} tAD779X_Dev;
